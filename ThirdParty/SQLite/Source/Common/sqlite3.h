...
**
** @(#) $Id: sqlite3.h 398 2008-12-27 22:59:06Z soothe $
*/
#ifndef _SQLITE3_H_
#define _SQLITE3_H_
...
/*
* Used to check if this is a correct version of SQLite
*/
int sqlite3_encryption_enabled(void);
/*
...
#define SQLITE_CANT_ENCR   27   /* Cannot encrypt database block */
#define SQLITE_CANT_DECR   28   /* Cannot decrypt database block */
#define SQLITE_VMISMATCH   29   /* Version mismatch */
